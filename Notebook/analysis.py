...
# ------------------------------------------------------------
# Analysis: Study Regional Sales Performance
# ------------------------------------------------------------

# Group the dataset by 'Region'
# Calculate the total revenue generated from each region
Region_sales = df.groupby('Region')['Total Revenue'].sum().head()

# ------------------------------------------------------------
# Visualization: Bar Chart of Revenue by Region
# ------------------------------------------------------------

# Create a bar chart to visualize total revenue generated by each region
plt.bar(
    Region_sales.index,   # Region names
    Region_sales.values,  # Total revenue values
    color=["red", "blue", "green", "orange", "purple"]
)

# Label the x-axis to represent different regions
plt.xlabel('Region')

# Label the y-axis to represent total revenue
plt.ylabel('Total Revenue')
...
# Save the chart as a high-resolution image
plt.savefig(
    "/content/drive/MyDrive/Region_sales.png",
    dpi=300,
    bbox_inches="tight"
)
